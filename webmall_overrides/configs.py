...
WEBMALL_BENCHMARKS = {
    ...
    "webmall_partial_basic_v1.0": lambda: WebMallBenchmark(
        name="webmall_partial_basic_v1.0",
        high_level_action_set_args=DEFAULT_HIGHLEVEL_ACTION_SET_ARGS["webarena"],
        is_multi_tab=True,
        supports_parallel_seeds=True,
        backends=["webmall"],
    ...
    "webmall_remaining_partial_basic_v1.0": lambda: WebMallBenchmark(
        name="webmall_remaining_partial_basic_v1.0",
        high_level_action_set_args=DEFAULT_HIGHLEVEL_ACTION_SET_ARGS["webarena"],
        is_multi_tab=True,
        supports_parallel_seeds=True,
        backends=["webmall"],
    ...
    "webmall_partial_advanced_v1.0": lambda: WebMallBenchmark(
        name="webmall_partial_advanced_v1.0",
        high_level_action_set_args=DEFAULT_HIGHLEVEL_ACTION_SET_ARGS["webarena"],
        is_multi_tab=True,
        supports_parallel_seeds=True,
        backends=["webmall"],
    ...
    "webmall_remaining_partial_advanced_v1.0": lambda: WebMallBenchmark(
        name="webmall_remaining_after_partial_advanced_v1.0",
        high_level_action_set_args=DEFAULT_HIGHLEVEL_ACTION_SET_ARGS["webarena"],
        is_multi_tab=True,
        supports_parallel_seeds=True,
        backends=["webmall"],
